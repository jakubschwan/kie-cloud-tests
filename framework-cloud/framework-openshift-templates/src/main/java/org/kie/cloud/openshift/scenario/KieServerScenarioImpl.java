...
public class KieServerScenarioImpl extends KieCommonScenario<KieServerScenario> implements KieServerScenario {
    ...
    protected void deployKieDeployments() {
        ...
        logger.info("Processing template and creating resources from {}", OpenShiftTemplate.KIE_SERVER.getTemplateUrl());
    ...
    @Override public List<Deployment> getDeployments() {
        List<Deployment> deployments = new ArrayList<Deployment>(Arrays.asList(kieServerDeployment, ssoDeployment));
